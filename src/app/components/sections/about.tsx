        ...
        <div className="flex flex-col" id="about">
            ...
            <div className="py-2">
              ...
              <p>Earlier this year in 2024, Renewvia published the first-ever peer-reviewed, comprehensive socioeconomic impact analysis for mini-grids in rural Africa.
                ...
                There is great potential for follow-up analyses to ask and answer interesting questions related to the impact of Renewvia&aposs work on communities and how better understanding that impact could influence the engineering design process.
                </p>
            </div>
            <div className="py-2">
